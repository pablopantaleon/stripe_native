                            ...
                            Activity.RESULT_OK -> {
                                if (data is Intent) {
                                    PaymentData.getFromIntent(data)?.let({
                                        plugin.flutterResult!!.success(
                                            "tok" + it.toJson().substringAfter("tokenizationData")
                                                .substringAfter("token").substringAfter("id")
                                                .substringBefore("object").substringAfter("tok")
                                                .substringBefore("\\\"")
                                        )
                                    })
                                }
